...
def test_load_enabled_toolsets_rejects_disabled_mcp_env(monkeypatch, capsys):
    ...
    # Sorted union of Matt-local non-configurable Apple Calendar/Kanban plus
    # upstream GUI-only project toolset folded into TUI fallback.
    assert server._load_enabled_toolsets() == ["apple_calendar", "kanban", "memory", "project"]
