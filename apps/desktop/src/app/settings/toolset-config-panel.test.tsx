...
describe('ToolsetConfigPanel', () => {
  ...
  it('saves an API key for a provider env var', async () => {
    ...
    // Open the credential actions menu, then click "Set" to reveal the input for the unset key.
    const actions = await screen.findByLabelText('Actions for ELEVENLABS_API_KEY')
